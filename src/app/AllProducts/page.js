...
const products = [
    { id: 1, name: 'The ordinary xyz serum- AHA BHA 10%', image: Serum, originalPrice: 399, price: 350 },
    { id: 2, name: 'The ordinary xyz serum- AHA BHA 10%', image: Serum, originalPrice: 399, price: 350 },
    { id: 3, name: 'The ordinary xyz serum- AHA BHA 10%', image: Serum, originalPrice: 399, price: 350 },
    { id: 4, name: 'The ordinary xyz serum- AHA BHA 10%', image: Serum, originalPrice: 399, price: 350 },
    { id: 5, name: 'The ordinary xyz serum- AHA BHA 10%', image: Serum, originalPrice: 399, price: 350 },
    { id: 6, name: 'The ordinary xyz serum- AHA BHA 10%', image: Serum, originalPrice: 399, price: 350 },
]

const filterTabs = ['Brand', 'Price', 'Category', 'Avg Customer Rating', 'Country Of Origin']

const filterOptions = {
    Brand: [
        { label: 'Aveeno', count: 2 },
        { label: 'Baby Dove', count: 3 },
        { label: 'Cos-IQ', count: 1 },
        { label: 'Dove', count: 9 },
        { label: "Johnson's", count: 1 },
        { label: 'Mustela', count: 11 },
        { label: 'Nat Habit', count: 1 },
        { label: 'Tulips', count: 1 },
    ],
    Price: [
        { label: 'Under ₹500', count: 12 },
        { label: '₹500 - ₹1000', count: 8 },
        { label: '₹1000+', count: 4 },
    ],
    Category: [
        { label: 'Serum', count: 6 },
        { label: 'Moisturizer', count: 5 },
        { label: 'Cleanser', count: 7 },
    ],
    'Avg Customer Rating': [
        { label: '4★ & above', count: 10 },
        { label: '3★ & above', count: 15 },
    ],
    'Country Of Origin': [
        { label: 'India', count: 14 },
        { label: 'Korea', count: 6 },
        { label: 'USA', count: 4 },
    ],
}
...
function SortFilterBar({ onFilterClick, onSortClick, sortLabel }) {
    return (
